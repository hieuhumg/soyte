...
?>
    ...
    <div class="form-info">
        <div class="container">
            <h3 class="title-content text-uppercase">Tra cứu thông tin</h3>
            <div class="row">
                <div class="col-md-6">
                    <div class="form">
                        <form action="" class="form-submit">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Số giấy phép">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Tên cơ sở">
                            </div>
                            <div class="form-group">
                            ...
                            <button class=" button button--nina button--text-thick button--text-upper button--size-s d-flex position-relative" data-text="Tìm kiếm">
                ...
                <div class="col-md-6">
                   <div class="info-result">
                       ...
                       <table class="w-100">
                           <tr>
                               <td style="width: 40%"><i class="fa fa-address-book" aria-hidden="true"></i> <span>Số giấy phép</span> </td>
                               <td style="width: 60%">0243H9-2018</td>
                           </tr>
                           <tr>
                               <td style="width: 40%"><i class="fa fa-star" aria-hidden="true"></i> <span>Tên cơ sở:</span>  </td>
                               <td style="width: 60%">Sở y tế quận Ba Đình</td>
                           </tr>
                           <tr>
                               <td style="width: 40%"><i class="fa fa-map-marker" aria-hidden="true"></i> <span>Địa chỉ:</span> </td>
                               <td style="width: 60%">Số 4, Sơn Tây, Ba Đình, Hà Nội</td>
                           </tr>
                           <tr>
                               <td style="width: 40%"><i class="fa fa-user" aria-hidden="true"></i> <span>Người đứng đầu:</span></td>
                               <td style="width: 60%">Quang Trung</td>
                           </tr>
                           <tr>
                               <td style="width: 40%"><i class="fa fa-phone" aria-hidden="true"></i> <span>Điện thoại:</span></td>
                               <td style="width: 60%">0243 3998 5765</td>
                           </tr>
                           <tr>
                               <td style="width: 40%"><i class="fa fa-envelope" aria-hidden="true"></i> <span>Email:</span></td>
                               <td style="width: 60%">info@soytehanoi.com</td>
                           </tr>
